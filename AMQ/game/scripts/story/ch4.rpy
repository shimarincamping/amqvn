label ch4:
    ...
    call initgame(game_settings["ch4"]["game1"], "bg dinner.jpg") from _call_initgame_3
    ...
    call initgamenodd(game_settings["ch4"]["game2"], gamebg="bg movies.jpg") from _call_initgamenodd_5
    ...
    call initgame(game_settings["ch4"]["game3"], gamebg="bg playground.jpg", randsong = True, fortniteloli=True) from _call_initgame_4
    ...
    call initgamenodd(game_settings["ch4"]["game4"], gamebg="bg perform.jpg", keion=True) from _call_initgamenodd_6
