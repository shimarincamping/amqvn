...
label rhythm_game_entry_label:
    ...
    while isinstance(selected_song, Song):
        ...
        $ renpy.notify('Use the Q, W, O, and P keys on your keyboard to hit the notes as they reach the end of the tracks. Good luck!')
...
init python:
    ...
    class RhythmGameDisplayable(renpy.Displayable):
        ...
        def __init__(self, song):
            ...
            self.hit_threshold = 0.15 # seconds
            self.perfect_threshold = 0.075 # seconds
            ...
            self.miss_text_drawable = Text('Miss!', color='#63A8FF', size=40) # small text
            self.good_text_drawable = Text('Good!', color='#A0FF63', size=43) # big text
            self.perfect_text_drawable = Text('Perfect!', color='#FFE063', size=46) # bigger text
        ...
        def event(self, ev, x, y, st):
            ...
            if ev.type == pygame.KEYDOWN:
                ...
                if not ev.key in self.keycode_to_track_idx:
                    return
                renpy.play("audio/snare.mp3", channel="sound")
